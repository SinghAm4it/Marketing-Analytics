...
cursor.execute("""
IF OBJECT_ID('fact_customer_reviews_with_sentiment', 'U') IS NOT NULL
DROP TABLE fact_customer_reviews_with_sentiment
""")
conn.commit()

# Create table manually
cursor.execute("""
CREATE TABLE fact_customer_reviews_with_sentiment (
    ReviewID INT,
    CustomerID INT,
    ProductID INT,
    ReviewDate DATE,
...
insert_query = """
INSERT INTO fact_customer_reviews_with_sentiment
(ReviewID, CustomerID, ProductID, ReviewDate, Rating, ReviewText, 
 SentimentScore, SentimentCategory, SentimentBucket)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
"""

for row in customer_reviews_df.itertuples(index=False):
